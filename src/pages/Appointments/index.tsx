...
export default function Appointments() {
  ...
  const Appointments = {
    ...
    complaints:
      "на стул до 3 раз в сутки, полуоформленный,сильные позывы в утреннее время, требующие незамедлительной дефекации, периодическое урчание и вздутие живота, тяжесть в эпигастрии",
  };
  ...
  return (
    <Box
      sx={{ backgroundImage: `url(${Image})`, width: "100vw", height: "100vh" }}
    >
      <Box>
        <PaddingBox>
          <Box
